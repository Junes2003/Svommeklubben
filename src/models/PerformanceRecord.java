...
public class PerformanceRecord {
    ...
    public String getTrainingBestTime() { return trainingBestTime; }
    public int getMemberID() { return memberID; }
    public int getRecordID() { return recordID; }
    public int getDisciplineID() { return disciplineID; }
    public String getTrainingBestDate() { return trainingBestDate; }

    @Override
    public String toString() {
        return "Præstationsrekord{" +
                "medlemsID=" + memberID +
                ", rekordID=" + recordID +
                ", disciplinID=" + disciplineID +
                ", bedsteTræningsDato='" + trainingBestDate + '\'' +
                ", bedsteTræningsTid='" + trainingBestTime + '\'' +
                '}';
    }
}